...
function validate(values) {
  ...
  if (!values.sponsor || values.sponsor.trim() === '') {
    errors.sponsor = 'Campo patrocinador é obrigatório!'
  }

  if (values.startAt > values.endAt) {
    errors.startAt = 'Data Início deve ser anterior à Data Fim!'
    errors.endAt = 'Data Fim deve ser posterior à Data Início'
  }
  return errors
}
